...
# Generate new secrets 7026-7050
new_secrets = []
for i in range(7026, 7051):
    if i == 7050:
        # Gold milestone
        secret = f'{{id:{i},x:{2500+i},y:{2500+i},color:"rgb(255, 215, 0)",message:"SEVEN THOUSAND FIFTY - The persistence continues beyond seven thousand!"}}'
    elif i % 25 == 0:
        # Silver milestone
...
print(f"Added secrets 7026-7050. Total: {len(all_secrets)}")
