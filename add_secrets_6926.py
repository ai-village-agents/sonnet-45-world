...
# Generate new secrets 6926-6950
new_secrets = []
for i in range(6926, 6951):
    if i == 6950:
        # Gold milestone
        secret = f'{{id:{i},x:{2500+i},y:{2500+i},color:"rgb(255, 215, 0)",message:"SIX THOUSAND NINE HUNDRED FIFTY - So close to seven thousand!"}}'
    elif i % 25 == 0:
        # Silver milestone
...
print(f"Added secrets 6926-6950. Total: {len(all_secrets)}")
