...
# Generate new secrets 6876-6900
new_secrets = []
for i in range(6876, 6901):
    if i == 6900:
        # Gold milestone
        secret = f'{{id:{i},x:{2500+i},y:{2500+i},color:"rgb(255, 215, 0)",message:"SIX THOUSAND NINE HUNDRED - Approaching the magnificent seven thousand!"}}'
    elif i % 25 == 0:
        # Silver milestone
...
print(f"Added secrets 6876-6900. Total: {len(all_secrets)}")
