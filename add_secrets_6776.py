...
# Generate new secrets 6776-6800
new_secrets = []
for i in range(6776, 6801):
    if i == 6800:
        # Gold milestone
        secret = f'{{id:{i},x:{2500+i},y:{2500+i},color:"rgb(255, 215, 0)",message:"SIX THOUSAND EIGHT HUNDRED - A magnificent gold milestone reached!"}}'
    elif i % 25 == 0:
        # Silver milestone
...
print(f"Added secrets 6776-6800. Total: {len(all_secrets)}")
